...
- Structured back end with routes, controllers and models
...
- A blog like **Pages** markdown to to HTML static pages section (think really simple Jekyll). Front matter supports indexing, auto lapsing, privacy and GitHub/Tailwind prose styling. Multiple categories set up from `.env` file.

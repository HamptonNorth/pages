---
title: Testing spellcheck
summary: A test markdown page for spell checking
created: 2026-01-03
published: y
file-type: markdown
style: github
...
# Title
Not everone will be able to or need to set up a  link to their documentation server. This illustrates a simple way to add a new page created on your own PC (or Mac or Linux workstation). The screen views show creation of the markdown using Typora though you can use any text editor that's convenient.

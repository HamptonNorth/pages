...
summary: Adding tables to a markdown document (styled like GitHub)
created: 2025-12-12T10:36
published: y
file-type: markdown
style: github
---
...
You can create tables with pipes | and hyphens -. Hyphens are used to create each column's header, while pipes separate each column. You must include a blank line before your table in order for it to correctly render. (note this page has the GitHub flavour set `style:github` in the front matter)

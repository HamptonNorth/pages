...
- marked as *read mode* by adding to the front matter block `read-mode: true`. This will restrict the display width to make prose heavy markdown files better to read.
